...
import com.g3net.type.Callback;
...
public class ArrayUtils {
	...
	public static byte[] append(byte[] src, byte[] append) {
		...
		return org.apache.commons.lang.ArrayUtils.addAll(src, append);
	...
	public static Object insert(Object srcArray, int insertPos, Object append) {
		...
		if (!append.getClass().isArray()) {
			...
			try {
				...
				Assert.state("the append's type[" + old.getClass()
...
//		return (Object[])result;
	...
	public static void reverse(Object array) {
		...
		if (c.isPrimitive()) {
			if (c == int.class)
				org.apache.commons.lang.ArrayUtils.reverse((int[]) array);
			else if (c == boolean.class)
				org.apache.commons.lang.ArrayUtils.reverse((boolean[]) array);
			else if (c == short.class)
				org.apache.commons.lang.ArrayUtils.reverse((short[]) array);
			else if (c == long.class)
				org.apache.commons.lang.ArrayUtils.reverse((long[]) array);
			else if (c == double.class)
				org.apache.commons.lang.ArrayUtils.reverse((double[]) array);
			else if (c == float.class)
				org.apache.commons.lang.ArrayUtils.reverse((float[]) array);
			else if (c == byte.class)
				org.apache.commons.lang.ArrayUtils.reverse((byte[]) array);
			else if (c == char.class)
				org.apache.commons.lang.ArrayUtils.reverse((char[]) array);
		} else {
			org.apache.commons.lang.ArrayUtils.reverse((Object[]) array);
		}
...
//		int[] src = new int[] { 8, 9, 67 };
//		byte[] append = new byte[] { 2, 3, 4, 6, 7 };
//		//	   
//		//int[] des = (int[]) insert(src, 7, new int[] { 'b' });
//		
//		int[]des2 =(int[])append(src,  56);
		//log.info(ArrayUtils.toString(des2));
		// byte[] des2=addLenToByteArrayHead(des);
		// des2=append(des2,addLenToByteArrayHead(des));
//		reverse(des);
//		log.info(ArrayUtils.toString(des, " "));
//		log.info(contains(des, 97));
//		Integer[] ss = (Integer[]) ArrayUtils.toObjectArray(src);
//		log.info(ArrayUtils.toString(ss, " "));
//
//		List<DateTime> list = new ArrayList<DateTime>();
//		list.add(new DateTime());
//		list.add(new DateTime());
//		DateTime[] ojs = (DateTime[]) ArrayUtils.toArray(list);
//		//log.info(ArrayUtils.toString(ojs, ","));
//		DateTime[] ds=(DateTime[])ArrayUtils.toArray(list);
//		log.info(ArrayUtils.toString(ArrayUtils.toArray(list)));
		// //
		// List<Integer> list = new ArrayList();
		// list.add(1);
		// list.add(2);
		// list.add(-333);
		// log.info(toString(IntegerListToIntegerArray(list)));

		// log.info(ObjectUtils.nullSafeToString((long[])null));

		// log.info(toString(IntegerListToIntegerArray(list)));
		// Object[] bss=getBytesFromLenByteArray(des2);
		// byte[] bsss=(byte[])bss[1];
		// log.info(HexUtils.format(bsss));

		// String[] s=new String[]{"123","345","566"};
		// log.info(StringArrayToLongArray(s)[1]);
		// String[][] as = new String[5][];
		// String[] bs = new String[] { "123", "456", "789" };
		// ArrayUtils.fill(as, bs);
		// // log.info(StringUtils.printStringArray(as));
		// for (int i = 0; i < as.length; i++) {
		// log.info(StringUtils.printStringArray(as[i]));
		// }
		 
		int[] is=new int[]{1,11,3,4,6,3,4,5};
		log.info(max(is));
		Integer[] ins=(Integer[])ArrayUtils.toObjectArray(is);
		log.info(ArrayUtils.toString(ins));
		Integer[] obs=ArrayUtils.removeDuplicateElements(ins);
		obs =ArrayUtils.getDuplicateElements(ins);
		log.info(ArrayUtils.toString(obs));
		
		Integer[] iis=ArrayUtils.map(new Integer[]{1,11,3,4,6,3,4,5}, new Callback<Integer,Integer>(){
			public Integer call(Integer obj){
				return obj+2;
			}
		});
		log.info(ArrayUtils.toString(iis));
