...
public class MultiThreadHttpClient {
	private static Logger log = Logger.getLogger(MultiThreadHttpClient.class);
	// /////////////////////////////////////////////////////////////////////
	public static int CONNECTTION_TIMEOUT = 10000;// 设置每个连接的超时时间
	public static int SO_TIMEOUT = 10000; // 设置socket的读写时间
	public static int MAX_CONNECTIONS = 40;
	// //////////////////////////////////////////////////////////////////

	public static DefaultHttpClient httpClient = 
		             MultiThreadHttpClient.getClient(MAX_CONNECTIONS,
			                         CONNECTTION_TIMEOUT, SO_TIMEOUT);;
	

	private HttpEntity requestEntity = null;		//请求实体
	private HttpEntity responseEntity = null;		//响应实体
	...
	private static DefaultHttpClient getClient(int maxTotalConnections,
		...
		ConnManagerParams.setTimeout(params, connectionTimeOut);// 从连接池里取出的连接的超时时间
	...
	//	Utils.createParamtersService(msp).getBytes("utf-8"), "utf-8"),"utf-8");
	//	log.info(s);
	}
