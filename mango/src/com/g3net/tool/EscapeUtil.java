...
import com.g3net.tool.StringUtils.GroupHandler;

public class EscapeUtil {
	private static final Logger log = Logger.getLogger(EscapeUtil.class);
	 ...
	 * @return
	 */
	public static String unescapeOnlyHtmlEntity(String s) {

		GroupHandler gh = new GroupHandler() {
			public String handler(String groupStr) {
				String code=HTML40_ARRAY.get(groupStr);
				if(code==null){
					return groupStr;
				}
				char c=(char)(0x0ffff&Integer.parseInt(code));
				return c+"";

			}
		};
		return StringUtils.replaceAll(s, "&([a-zA-Z]*?);", 1, gh);
	}
	...
	public static void main(String[] args) throws IOException {
		// log.info(escapeXml("ttyy中国;dd  &#x4f54;&ddbread & butter"));
		// log.info(unescapeHtml("ttyy&#x4f54;dd  &#x4f54;&dd;&nbsp;dddd"));
//		log.info(unescapeHtml("ssss&nbsp;&#8226;fdf"));
//		FileUtils
//				.write("d:/tt1.txt", unescapeHtml("&nbsp;&#8226;fdf"), "utf-8");
//		// log.info(escapeUrl("五花八门","gbk"));
		
		// const unsigned short rdquo[] = { 0x201C, 0 }; //“
		// m_entityMap.insert(L"ldquo", TPtrC(ldquo));

		log.info(EscapeUtil.unescapeOnlyHtmlEntity("&#8226;"));
		log.info((int)'中');
		log.info(EscapeUtil.unescapeXml("&#20013;"));
		System.out.print(ByteUtils.toHexAscii("中".getBytes("utf-16be"), " "));
	}
}
