...
public class FileUtils {
	 ...
	 *  which match an array of extensions. This method is based on listFiles(File, String[], boolean). 
	 * 
	 * @param directory - the directory to search in
	 * @param extensions- an array of extensions, ex. {"java","xml"}. If this parameter is null, all files are returned.
	 * @param recursive
	 ...
	 * 
	 * This method copies the specified directory and all its child directories and files 
	 * to the specified destination. The destination is the new location and name of the 
	 * directory. 
	 * 
	 * The destination directory is created if it does not exist. If the destination directory 
	 * did exist, then this method merges the source with the destination, with the
	 ...
	 * 
	 * This method copies the source directory and all its contents to a directory of 
	 ...
	 * 
	 * This method copies the contents of the specified source file to a file of the same 
	 * name in the specified destination directory. The destination directory is created 
	 * if it does not exist. If the destination file exists, then this method will overwrite it. 
	 ...
	 *does not exist. An exception is thrown if the file object exists but is a directory. An exception is thrown if the file exists but cannot be written to. An exception is thrown if the parent directory cannot be created. 
	 *
	...
	public static File[] listOnlySubDirs(String path){
		File fpath=new File(path);
		Assert.isTrue(fpath.isDirectory(), "["+fpath.getAbsolutePath()+"]must be a dir!");
...
//		}
	...
	public static void write(String pathName, String content,boolean append) throws IOException{
	...
	public static void write(String pathName, String content,String charset) throws IOException{

		write(pathName, content, false,charset);

	}
	public static void write(String pathName, String content,boolean append,String charset) 
	throws IOException{
...
//		log.info("");
    ...
    throws IOException{
		Assert.isTrue(directory.isDirectory(),"["+directory.getAbsolutePath()+"]must be a directory");
	...
	public static boolean emptyDirectory(File directory) {
		...
		Assert.isTrue(directory.isDirectory(), "["+directory.getAbsolutePath()+"]must be a dir");
...
//		return bs;
	...
	public static byte[] readBytes(Reader in,String charset) throws IOException {
...
//		return bs;
	 ...
	 * @throws IOException
	 */
	public static String readTxt(Reader in) throws IOException{
